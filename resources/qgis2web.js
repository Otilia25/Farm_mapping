...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 22, projection: new ol.proj.Projection({
            code: 'EPSG:32735',
            //extent: [643530.962417, 8297575.037109, 643559.985841, 8297605.592804],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([643532.420134, 8297576.252890, 643559.293689, 8297603.288090], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_farm_3_planting_row_centroids_3,
    colName: 'Crop Varie',
    zoom: 10,
    collapsed: true,
    map: map,
